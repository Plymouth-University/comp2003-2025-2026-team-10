...
def generate_vorticitymaps(input_folder, output_folder):
    print("Generating vorticity maps from surface vorticity data...")
    ...
    for i, filename in enumerate(csv_files):
        ...
        out_path = os.path.join(output_folder, f"vorticitymap_{i}.png")
        ...
        v_col = find_col(header, "vorticity_mag")
    ...
    print(f"Vorticity maps done: {len(csv_files)} frames written to {output_folder}")
