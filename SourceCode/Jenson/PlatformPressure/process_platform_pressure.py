...
def generate_platform_pressuremaps(input_folder, output_folder):
    print("Generating platform pressure maps from platform surface data...")
    ...
    for i, filename in enumerate(csv_files):
        ...
        out_path = os.path.join(output_folder, f"platformpressure_{i}.png")
    ...
    print(f"Platform pressure maps done: {len(csv_files)} frames written to {output_folder}")
